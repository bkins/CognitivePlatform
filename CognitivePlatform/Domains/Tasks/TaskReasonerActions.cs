...
/// tasks and optionally recent journal entries, then delegates analysis to the LLM.
///
/// Design decisions:
/// - Calendar context is a planned follow-on once calendar integration exists (see DEFERRED.md).
