...
public interface IPersonaRuntime
{
    ...
    Task<PersonaConversationContext>   BuildConversationContextAsync(Guid personaId, string userMessage, ConversationMode mode = ConversationMode.FreeConversation, CancellationToken cancellationToken = default);
}
